...
- [Pastefy](https://github.com/interaapps/pastefy) - Beautiful, simple and easy to deploy Pastebin with optional Client-Encryption, Multitab-Pastes, an API, a highlighted Editor and more! ([Demo](https://pastefy.ga), [Source Code](https://github.com/interaapps/pastefy), [Clients (IDEs/CLI)](https://github.com/topics/pastefy-addon), [Api-Clients](https://github.com/interaapps/accounts-java-client)) `MIT License` `Java`
